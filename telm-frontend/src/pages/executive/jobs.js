...
const Jobs = () => {
    ...
    }, [searchQuery, currentPage, filterState, dispatch]);
    ...
    return (
        <DefaultLayout padded={!isMobile}>
            <Card sx={{width: '100%'}} className={isMobile ? "card-mobile-items" : ""}>
                ...
                {!isMobile &&
                    <JobTable loading={loading} jobs={jobs} user={user} onViewClick={handleViewDialogOpen}
                              pagination={pagination}
                              onTablePageChange={handlePageChange}/>
                }
                {isMobile &&
                    <MobileJobTable loading={loading} jobs={jobs} user={user} onViewClick={handleViewDialogOpen}
                                    pagination={pagination}
                                    onTablePageChange={handlePageChange}/>
                }
                {isViewDialogOpen &&
