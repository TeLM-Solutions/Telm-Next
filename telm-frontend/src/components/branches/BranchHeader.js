...
const BranchHeader = ({branches, onClickAdd, onSearch, isLoading, total, onClickMobileSearch, searchQuery}) => {
    ...
    return (
        ...
        >
            ...
            <Box sx={{display: 'flex', gap: '2rem', alignItems: 'center'}}>
                {!isMobile &&
                    <TableSearch label={"Search by branch name"} onSearch={onSearch}/>
                }
