...
const ExecutiveHeader = ({executives, onClickAdd, isLoading, onSearch, total, onClickMobileSearch, searchQuery}) => {
    ...
    return (
        ...
        >
            ...
            <Box sx={{display: 'flex', gap: '2rem', alignItems: 'center'}}>
                {!isMobile &&
                    <TableSearch label={"Search by name"} onSearch={onSearch}/>
                }
